...
- `<leader>ch` is Obsidian's checkbox toggle mapping. It is buffer-local for markdown/Obsidian files and kept for plugin compatibility.
...
Emmet runs through LSP completions (`emmet-language-server`) in the cmp menu.
